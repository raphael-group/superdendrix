...
#SBATCH --job-name='CT.l.1'
#SBATCH -a 2-768
#SBATCH -N 1
#SBATCH -c 4
#SBATCH --mem=4G
#SBATCH -o /n/fs/ragr-research/projects/sd/gitrepo/superdendrix/experiments/21Q1/gmm/logs_BIC0/CT.lung.k5.p10000.1.out.%a.txt
#SBATCH -e /n/fs/ragr-research/projects/sd/gitrepo/superdendrix/experiments/21Q1/gmm/logs_BIC0/CT.lung.k5.p10000.1.err.%a.txt
#SBATCH -t 0-12:00:00
...
EVENTS='data/21Q1/features/IOmerged/CERES_OncoKB_'$ALT'_lung_merged.tsv'	#Ceres alterations
...
OUTDIR='experiments/21Q1/'$RUNID'/cycle'$CYCLE'_BIC0/k'$K'/'$ALT'_lung/'
mkdir -p $OUTDIR

NULLMAT='data/21Q1/features/rand_mat/'$ALT'_lung/' #full mut NONSILENT
